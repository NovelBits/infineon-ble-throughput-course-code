/*******************************************************************************
 * Lab 4 Reference Configuration — Peripheral
 *
 * PHY gate ON (2M), connection parameter gate ON, CI = 7.5 ms, DLE = 251,
 * MTU exchange ON (MTU = 247).
 *
 * To use: copy this file to peripheral/app_config.h and rebuild.
 ******************************************************************************/
...
#define APP_ENABLE_MTU_EXCHANGE         (1)
