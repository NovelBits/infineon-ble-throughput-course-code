...
/* TODO: Enable PHY update to allow switching from 1M to 2M PHY
 * Set this to 1 to enable the PHY update request after connection
 */
#define APP_ENABLE_PHY_UPDATE           (0)     /* Change to (1) */
...
/* TODO: Select the 2M PHY for higher data rate
 * Options: APP_PHY_1M (default, 1 Mbps) or APP_PHY_2M (2 Mbps)
 */
#define APP_SELECTED_PHY            APP_PHY_1M  /* Change to APP_PHY_2M */
